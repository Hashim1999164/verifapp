...
class CallToImpl: BaseOtpImpl {
    ...
    override func getNetworkRequest(params: [String : Any]) -> HTTPRequestItem {
    ...
    override func getVerifyRequest(params: [String : Any]) -> HTTPRequestItem {
    ...
    override func onNetworkSuccess(response: HttpResponseItem, completion: @escaping (OTPCodes, String, Bool) -> ()) {
        ...
        completion(OTPCodes.OTP_SENT, "Call Request Sent", true)
            var ud = UserDefaults()
        ...
        completion(OTPCodes.SMS_SENDING_FAILED, "Failed Requesting Call, Trying Next Case", false)
        super.dispose()
    }
    ...
    override func getTimeout() -> Int64 {
        return 40000 // CALL TIMEOUT IMPLEMENTATION
    }
